...
<body>
	<marquee>
   This Application is Developed by Sheikh Abujar. 
  </marquee>
	<div id="wrapper">
    <div id="header">
    	<div id="login_menu">
...
<td>
	...
	<select name ="id">
 				 ...
 				 <option  value="<%=rs.getString("id")%>"  >Edit</option>
 				 <option  value="<%=rs.getString("id")%>" >Forward</option>
 				 <option  value="<%=rs.getString("id")%>" >Delete</option>
 				
 				 
			</select> 
			<input type="image" name="id" src="forward.png"  value="<%=rs.getString("id")%>" alt="Submit">
   		<input type="image" onclick="window.location.href='www.google.com'" name="id" src="Delete.jpg"  value="<%=rs.getString("id")%>" alt="Submit">
       ...
       <td height="15"><input type="Submit" name="Submit" value="Submit" ></td>
